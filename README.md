...
- **Element Plus**: 高质量的Vue 3组件库
- **Vite**: 极速前端构建工具，支持HMR热更新
- **Pinia**: 轻量级Vue 3状态管理库
- **Vue Router**: 官方声明式路由管理器
- **Axios**: HTTP客户端库，API通信
- **ECharts**: 数据可视化图表库
- **WebSocket**: 实时通信支持
...
# Web界面 (Vue3前端)
cd web && npm run dev    # 启动开发服务器 (端口3000)
cd web && npm run build  # 构建生产版本
cd web && npm run preview # 预览生产版本
```
